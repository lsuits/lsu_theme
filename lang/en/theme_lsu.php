...
/**
 * Strings for component 'theme_lsu', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   moodlecore
...
<div class="clearfix">
	...
	<div class="theme_description">
		...
		<h2>About</h2>
		<p>This is LSU\'s default theme</p>

		<h2>Tweaks</h2>
		<p>This theme is built upon Base, included in the Moodle core.</p>
...
$string['hovercolordesc'] = 'This sets the link hover color for the theme.';
$string['configtitle'] = 'LSU settings';
...
$string['logowidthdesc'] = 'Enter the width of your logo in pixels. It should be something like 275';
$string['logo_height'] = 'Logo Height';
$string['logoheightdesc'] = 'Enter the height of your logo in pixels. It should be something like 43';
